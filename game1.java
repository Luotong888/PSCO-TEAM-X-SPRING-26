...
public class DicePatternsChallenge {
    ...
    private static ScoreResult score(int[] dice) {
        ...
        if (freq.equals(Arrays.asList(5))) {
            return new ScoreResult("Five of a Kind", 50);
        } else if (freq.equals(Arrays.asList(4, 1))) {
            return new ScoreResult("Four of a Kind", 40);
        } else if (freq.equals(Arrays.asList(3, 2))) {
            return new ScoreResult("Full House", 35);
        } else if (straight) {
            return new ScoreResult("Straight", 30);
        } else if (freq.equals(Arrays.asList(3, 1, 1))) {
            return new ScoreResult("Three of a Kind", 25);
        } else if (freq.equals(Arrays.asList(2, 2, 1))) {
            return new ScoreResult("Two Pairs", 20);
        } else if (freq.equals(Arrays.asList(2, 1, 1, 1))) {
            return new ScoreResult("One Pair", 10);
        } else {
    ...
    private static class ScoreResult {
        ...
        ScoreResult(String name, int points) {
            this.name = name;
            this.points = points;
        }
    }
